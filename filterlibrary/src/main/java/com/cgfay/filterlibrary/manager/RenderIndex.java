...
public final class RenderIndex {
    public static final int PhotoIndex = 0;     //图片输入索引
    ...
    public static final int BIGEYE = 9;      // 暗角索引
    public static final int SLIMFACE2 = 10;     // 人脸关键点索引
    public static final int SMALLFACE = 11;     // 人脸关键点索引
    public static final int DisplayIndex = 12;       // 显示索引
